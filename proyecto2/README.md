...
Las VLAN se organizan de acuerdo con la cantidad de equipos necesarios para cada una, ordenándolas de mayor a menor.
...
### Asignacion de mascara y wildcard
...
### Asignación de ID Red, Primera IP, Ultima IP e IP Broadcast

Donde:

* XX = 29
* Red Interna = 192.168.XX.0/24 = 192.168.29.0/24

A modo de ejemplo, se utilizará la VLAN 'Ventas'.

1. **Asignación de ID Red**

    Se asigna exclusivamente la red interna inicial.
